            ...
            {showAuthButtons && !isAuthenticated && (
              <>
                <Link
                  ...
                  className='border-foreground text-foreground inline-flex h-10 items-center justify-center rounded-lg border text-sm font-medium transition-opacity hover:opacity-90 active:opacity-80'
                >
                  {t('Sign up')}
                </Link>
                <Link
